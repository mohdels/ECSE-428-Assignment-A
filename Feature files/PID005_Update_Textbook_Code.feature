Feature: Update Textbook Code
  ...
  As a seller
  I want to be able to update the code (e.g., ISBN) of a used textbook post
  so that it accurately reflects the book's information.

  Scenario: Update a textbook code
    ...
    And the user updates the code of the textbook
  ...
  Scenario: Try to update textbook code with an empty field
    Given the user is logged in to their account
    And editing a post they created
    When the user tries to update the textbook's code with an empty field
